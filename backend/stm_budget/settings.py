"""
Django settings for STM Budget project with high-performance optimizations.
"""
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'apps.core.pagination.OptimizedCursorPagination',
    'PAGE_SIZE': 50,
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'STM Budget API',
    'DESCRIPTION': 'High-performance sales budget and forecast management API',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'COMPONENT_SPLIT_REQUEST': True,
}

# Celery Configuration - Disabled for SQLite development
# For development with SQLite, we'll disable Celery
